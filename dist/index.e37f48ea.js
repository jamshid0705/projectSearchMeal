...
var _recipeViewsJs = require("./recipeViews.js");
...
const showRuntime = async function() {
    try {
        ...
        console.log(id);
        _recipeViewsJsDefault.default.spinner();
        await _modulJs.modul(id);
        _recipeViewsJsDefault.default.recipeView(_modulJs.state.recipe);
    } catch (err) {
        alert(err);
    }
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","regenerator-runtime":"dXNgZ","./modul.js":"74CCC","./recipeViews.js":"hbGlb"}],"gkKU3":[function(require,module,exports) {
...
parcelHelpers.export(exports, "modul", ()=>modul
);
...
const modul = async function(id) {
    try {
        const dataJson = await _helperJs.getjson(_configJs.Api_url + id);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","regenerator-runtime":"dXNgZ"}],"hbGlb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class view {
    ...
    #ingredients = function(obj) {
        ...
        <svg class="recipe__icon">
          <use href="${_iconsSvgDefault.default}#icon-check">${val.unit}</use>
        </svg>
